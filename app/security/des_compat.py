"""DES compatibility helpers for TightVNC password handling."""


class _DES:
	"""Minimal DES implementation for one 8-byte ECB block."""
	...
	def _feistel(self, r, subkey):
		...
		return self._permute(p_table, out_bits)
...
def encrypt_tightvnc_password(password: str) -> str:
	"""Convert plaintext TightVNC password to encrypted hex form."""
